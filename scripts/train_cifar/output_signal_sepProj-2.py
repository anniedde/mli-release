...
torch.save(signals_dict, os.path.join(path, 'true_signals-2.pt'))
...
plt.savefig(os.path.join(path, 'signals-2.png'), dpi=300)

with open(os.path.join(path, 'signals-2.json'), 'w') as f:
