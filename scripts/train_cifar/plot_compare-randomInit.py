...
with open('/usr/xtmp/CSPlus/VOLDNN/Annie/mli-release/output_signal_data/vgg19-noBN-sgd-lr0_01-alpha0_5-trueSignal-run1/signals_randomInit.json') as f:
    signals = json.load(f)
#layers = signals["layers"]
#signals = signals["signals"]

with open('/usr/xtmp/CSPlus/VOLDNN/Annie/mli-release/output_signal_data/vgg19-noBN-sgd-lr0_01-alpha0_5-trueSignal-run1/norms_randomInit.json') as f:
    norms = json.load(f)
...
plt.savefig('/usr/xtmp/CSPlus/VOLDNN/Annie/mli-release/output_signal_data/vgg19-noBN-sgd-lr0_01-alpha0_5-trueSignal-run1/signals-norms-randomInit.png', dpi=300)
